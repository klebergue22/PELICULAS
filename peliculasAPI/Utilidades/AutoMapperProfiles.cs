    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles(GeometryFactory geometryFactory)
        {
            ...
            CreateMap<PeliculaCreacionDTO, Pelicula>()
                ...
                .ForMember(x => x.PeliculaGeneros, opciones => opciones.MapFrom(MapearPeliculasGeneros))
        ...
        private List<GeneroDTO> MapearPeliculasGeneros(Pelicula pelicula, PeliculaDTO peliculaDTO)
        {
            ...
            if (pelicula.PeliculaGeneros != null)
            {
                foreach (var genero in pelicula.PeliculaGeneros)
                {
        ...
        private List<PeliculaGeneros> MapearPeliculasGeneros(PeliculaCreacionDTO peliculaCreacionDTO,
            Pelicula pelicula)
        {
